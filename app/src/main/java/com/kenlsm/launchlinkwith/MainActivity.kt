...
class MainActivity : AppCompatActivity() {
    var activities: List<ResolveInfo> = emptyList()
    ...
    fun handleLaunch(view: View) {
        ...
        val s = activities.map { t -> t.activityInfo.packageName }.joinToString()
        alert(activities[1].activityInfo.packageName)
        tt.text = s

    }

    fun handleSend(view: View) {
        val act = activities[1]
